export default {
  ...
  contactForm: {
    ...
    send: '送出',
    sending: '送出中...',
    emailModalTitle: '郵件內容',
    emailModalDesc: '由於環境限制，無法直接開啟郵件應用程式。請複製以下內容手動發送郵件：',
    recipient: '收件人',
    subject: '主旨',
    body: '內容',
    copyAll: '複製全部內容',
  ...
  featuredPhotos: {
    ministryHeader: "與教育部潘文忠部長合影",
    ministryDescription: "參加 2023 國際發明展金牌得獎學生接見活動。",
    coscupHeader: "COSCUP",
    coscupDescription: "於 COSCUP 2023 的 Lightning Talk 擔任講者。",
  },
  infoCards: {
